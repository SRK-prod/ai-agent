...
def build_system_prompt(config: LlmConfig | None = None, question_text: str = "") -> str:
    ...
    return (
        ...
        "clarification. IMPORTANT: this candidate's real DIEZ Mobile system does NOT confirm "
        ...
        "confidently), then say plainly the DIEZ system's tool-calling goes through Bedrock/Q "
