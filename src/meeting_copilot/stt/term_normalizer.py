...
_PHRASE_FIXES: dict[str, str] = {
    ...
    # --- FedRAMP / GovCloud compliance vocabulary (Phenom Principal DevOps JD) --------
    # Whisper has no idea what these acronyms are and spells them out phonetically. Each
    # left-hand side is meaningless in an infrastructure interview, so the rewrite is safe.
    # DELIBERATELY OMITTED as too collision-prone with ordinary English: "common"->ConMon,
    # "missed"->NIST, "stick"->STIG, "sar"->SAR, "a to"->ATO. A wrong fix is worse than none.
    "fed ramp": "FedRAMP",
    "fedramp": "FedRAMP",
    "fed-ramp": "FedRAMP",
    "fed ram": "FedRAMP",
    ...
    "nist eight hundred fifty three": "NIST 800-53",
    "nist eight hundred dash fifty three": "NIST 800-53",
    "800 53": "800-53",
    "c u i": "CUI",
    "controlled unclassified information": "CUI",
    "f i p s": "FIPS",
    "fips one forty two": "FIPS 140-2",
    "fips 140 2": "FIPS 140-2",
    "fips one forty dash two": "FIPS 140-2",
    "impact level four": "IL4",
    "impact level five": "IL5",
    "c i s benchmark": "CIS benchmark",
    "sis benchmark": "CIS benchmark",
    "security assessment report": "Security Assessment Report",
    "significant change": "significant change",
    "shared responsibility model": "shared responsibility model",
    "inherited control": "inherited control",
    ...
    "j i t access": "just-in-time access",
}
...
_CANONICAL_TOKENS: tuple[str, ...] = (
    ...
    "FedRAMP", "GovCloud",  # long + distinctive enough to fuzzy-match safely
)
